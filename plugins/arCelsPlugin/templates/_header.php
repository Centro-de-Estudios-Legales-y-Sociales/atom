      ...
      <div class="row">
        <div class="span12">
          ...
          <?php if ('fr' == $sf_user->getCulture()) { ?>
            <a id="header-council" href="http://cdncouncilarchives.ca"><?php echo image_tag('/plugins/arCelsPlugin/images/council.fr.png', ['width' => '156', 'height' => '42', 'alt' => __('Canadian Council of Archives')]); ?></a>
          <?php } else { ?>
            <a id="header-council" href="http://cdncouncilarchives.ca"><?php echo image_tag('/plugins/arCelsPlugin/images/council.en.png', ['width' => '156', 'height' => '42', 'alt' => __('Canadian Council of Archives')]); ?></a>
          <?php } ?>

          <ul id="header-nav" class="nav nav-pills">

            <?php if ('fr' == $sf_user->getCulture()) { ?>
              <li><?php echo link_to(__('Home'), 'https://www.cels.org.ar'); ?></li>
            <?php } else { ?>
              <li><?php echo link_to(__('Home'), 'https://www.cels.org.ar'); ?></li>
            <?php } ?>
    ...
    <div id="header-lvl2">
      <div class="row">
        ...
        <div id="logo-and-name" class="span6">
          <?php if ('fr' == $sf_user->getCulture()) { ?>
            <h1><?php echo link_to(image_tag('/plugins/arCelsPlugin/images/logo.png', ['alt' => __('Archivo CELS')]), 'https://www.cels.org.ar/homeFR', ['rel' => 'home']); ?></h1>
          <?php } else { ?>
            <h1><?php echo link_to(image_tag('/plugins/arCelsPlugin/images/logo.png', ['alt' => __('Archivo CELS')]), 'https://www.cels.org.ar', ['rel' => 'home']); ?></h1>
          <?php } ?>
        </div>
